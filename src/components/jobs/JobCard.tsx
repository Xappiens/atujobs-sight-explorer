...
const JobCard: React.FC<JobCardProps> = ({ job }) => {
  ...
  return (
    <Card className={`hover:border-job-blue transition-all ${job.featured ? 'border-l-4 border-l-job-blue' : ''}`}>
            ...
            <div className="flex-grow">
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  {job.featured && (
                    <Badge variant="secondary" className="bg-job-lightBlue text-job-blue border-none">
                      Destacado
                    </Badge>
                  )}
